...
export const LOCAL_OUTDOOR_PRODUCTS: OutdoorProduct[] = [
  ...
  // Category 2: Garden Sofas
  {
    ...
    usdPrice: 1200,
    pkrPrice: 336000,
    img: U('photo-1493809842364-78817add7ffb', 800),
    gallery: [U('photo-1493809842364-78817add7ffb', 800)],
  ...
  },
  {
    ...
    usdPrice: 1850,
    pkrPrice: 518000,
    img: U('photo-1484154218962-a197022b5858', 800),
    gallery: [U('photo-1484154218962-a197022b5858', 800)],
